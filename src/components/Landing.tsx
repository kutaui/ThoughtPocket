  ...
  return (
    <main className={styles['landing-container']}>
      <div className={styles['title-container']}>
        <h1 className={styles['first-title']}>
          Your <span>Thoughts</span>
        </h1>
        <h1 className={styles['second-title']}>
          In Your <span>Pocket</span>
        </h1>
      </div>
      <div className={styles['text-container']}>
        <p className={styles['first-paragraph']}>
          Welcome to a world where your thoughts come alive, accessible anytime,
          anywhere.
        </p>
        <p className={styles['second-paragraph']}>
          Unlock the Boundless Potential of Your Thoughts and Supercharge Your
